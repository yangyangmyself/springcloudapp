...
public class RsaKeyTools {
	...
	public static PublicKey convertPublicKey(String keyStr, String alg) throws Exception {
		byte[] keyBytes = Base64.encode(Base64.decode(keyStr.getBytes()));
		X509EncodedKeySpec keySpec = new X509EncodedKeySpec(keyBytes);
		KeyFactory keyFactory = KeyFactory.getInstance(alg);
		return keyFactory.generatePublic(keySpec);
	}

	public static PrivateKey convertPrivateKey(String keyStr, String alg) throws Exception {
		byte[] keyBytes = Base64.encode(Base64.decode(keyStr.getBytes()));
